...
from Modules.segrefiner_base import SegRefiner  # 确保这个路径正确
...
def train(config_path: str):
    ...
    shutil.copy("Modules/segrefiner_base.py", output_dir)  # 复制模型定义文件
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='Config/trainStage2ImageToDEM-瑞士2_512.json')
