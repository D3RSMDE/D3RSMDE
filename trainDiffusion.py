...
def train(config_path: str):
    ...
    if "Ast" in cfg["dataset_path"] or "J_K" in cfg["dataset_path"]:  # Special case for Ast and J_K datasets, no val
    ...
    model = D3_Diffusion(device=device, **cfg).to(device)  # todo
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='Config/trainStage2ImageToDEM-Swi2_512.json')
