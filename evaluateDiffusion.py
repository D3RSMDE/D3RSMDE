...
from Modules.segrefiner_base import SegRefiner
...
def evaluate(config_path: str):
    ...
    shutil.copy("Modules/segrefiner_base.py", output_dir)  # 复制模型脚本
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='Config/testStage2ImageToDEM-瑞士2_512.json')
